...
public class Player extends Entity {
	...
	public Player(float x, float y, GameMap map, float maxHealth, float attackDamage, float speed, float jumpVelocity, String weaponID, String skin) {
	...
	private void loadAnimationFrames(String animation, int priority, float deltaTime) {
		String data="";
		if(animationTimer>=frameCount*frameDuration||priority>=currentPriority) {
		if(animation=="Walk") {
			frameCount = 8;
			frameDuration = 0.1f;
		}
