...
public class LevelEndScreen extends Interface{
    ...
    public void create() {
        ...
        super.create();
        addImageButton((Gdx.graphics.getWidth()-buttonWidth)/2f, Gdx.graphics.getHeight()/2f+buttonHeight, buttonWidth, buttonHeight, buttonWidth, buttonHeight, "Interfaces/Buttons/NextButton.png");
