...
public abstract class GameMap {
	...
	public GameMap() {
		...
		loadEntitiesFromJson("playerData.json");
		System.out.println("Check");
		player=(Player) entities.get(0);
		loadEntitiesFromJson("Map/Floor1/Room1/entities.json");
	}
	 ...
	 protected void loadEntitiesFromJson(String jsonFilePath) {
	    ...
	    private Entity createEntityFromData(EntityData entityData) {
	        if ("Player".equals(entityData.type)) {
	            return new Player(entityData.x, entityData.y, this, entityData.health, entityData.attackDamage, entityData.speed, entityData.jumpVelocity, entityData.weaponID, entityData.skin);
	        } else if ("Slime".equals(entityData.type)) {
	            return new Slime(entityData.x, entityData.y, this, entityData.health, entityData.attackDamage, entityData.speed, entityData.jumpVelocity, entityData.weaponID);
	        }
